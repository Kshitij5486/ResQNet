      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-slate-900 border-r border-slate-800 p-12 relative overflow-hidden">
        ...
        <div className="relative space-y-4">
          ...
          <div className="pt-4 border-t border-slate-800">
            <p className="text-slate-600 text-xs">Java 21 · Spring Boot 3.3 · Apache Kafka 3.7 · Python FastAPI · React 18 · PostgreSQL 16 · Redis 7 · Docker · Kubernetes</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-600 text-xs">
              ...
              <button onClick={() => navigate('/register')} className="text-blue-400 hover:text-blue-300 transition-colors font-medium">Register</button>
            </p>
          </div>
